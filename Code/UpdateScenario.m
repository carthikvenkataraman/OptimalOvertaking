...
updTask.L.x0    = updTask.L.x0 + (updTask.L.vx - decision.vEx(2))*dt;

if updTask.adjacentveh
    updTask.A.x0 = updTask.A.x0 + (updTask.A.vx - decision.vEx(2))*dt;
end

if updTask.adjacentveh2
    updTask.A2.x0 = updTask.A2.x0 + (updTask.A2.vx - decision.vEx(2))*dt;
end
end